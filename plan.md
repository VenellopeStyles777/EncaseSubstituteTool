...
| 2 | Add volume/filesystem browsing MVP | In Progress | S2-T02 adds the read-only byte-stream foundation after S2-T01 defined fixture/dependency strategy. Volume discovery, filesystem adapter boundary, and one browsable fixture/stub tree remain upcoming. |
