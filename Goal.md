...
4. Hash/signature analysis: add file hashing, known-file matching, file type detection, and mismatch flags. Status: in progress; S4-T01 contracts, S4-T02 provider-backed hashing, S4-T03 file signature detection, and S4-T04 extension mismatch rules are reviewed and done.
...
- S4-T02 provider-backed hashing, S4-T03 file signature detection, and S4-T04 extension mismatch rules are reviewed and done.
