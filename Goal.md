...
4. Hash/signature analysis: add file hashing, known-file matching, file type detection, and mismatch flags. Status: in progress; S4-T01 contracts, S4-T02 provider-backed hashing, and S4-T03 file signature detection are reviewed and done.
...
- S4-T02 provider-backed hashing and S4-T03 file signature detection are reviewed and done.
