...
Do not hand any Stage 3 ticket after S3-T01 to the implementation agent until its individual ticket file and prompt are reviewed for the current code state. S3-T01 is reviewed and done.
