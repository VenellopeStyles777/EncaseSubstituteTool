...
- `stage-4/`: hash/signature foundations. Status: in progress; S4-T00 review-agent risk audit, S4-T01 contract ticket, S4-T02 provider-backed hashing, and S4-T03 file signature detection done.
