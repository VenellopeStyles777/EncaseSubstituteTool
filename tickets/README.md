...
- `stage-4.5/`: first testing with user-provided E01 files. Status: planning package in review; S4.5-IMP01, S4.5-IMP02, S4.5-IMP02A, S4.5-IMP03, and S4.5-IMP04 are done, and S4.5-IMP05 through S4.5-IMP07 remain drafted before Stage 5 search/timeline resumes.
