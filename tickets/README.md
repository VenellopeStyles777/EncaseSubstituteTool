...
- `stage-4.5/`: first testing with user-provided E01 files. Status: planning package in review; S4.5-IMP01, S4.5-IMP02, S4.5-IMP02A, S4.5-IMP03, S4.5-IMP04, S4.5-IMP05, and S4.5-IMP06 are done, and S4.5-IMP07 remains drafted before Stage 5 search/timeline resumes.
